# comando para rodar o app 'streamlit run app.py'
# para parar o app, usar 'Ctrl + C' no terminal

import streamlit as st

# streamlit é a biblioteca principal para criar o dashboard interativo, nome padrão st
import pandas as pd
